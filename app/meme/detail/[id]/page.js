  ...
  return (
    <div className="flex flex-col min-h-screen font-GowunBatang bg-white text-gray-900">
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 md:px-10 py-6 sm:py-10">
        <h1 className="font-GowunBatangBold text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-4 sm:mb-6 tracking-wide">{meme.title}</h1>
        ...
        <div className="mx-2 sm:mx-6 md:mx-16 p-4 sm:p-6 rounded-xl" data-color-mode="light">
        ...
        {/* 댓글/좋아요는 CSR로 처리 */}
        <MemeCommentsWrapper memeCode={meme.code} likesCount={meme.likesCount} orgMemeCode={meme.orgMemeCode} />
      </main>
